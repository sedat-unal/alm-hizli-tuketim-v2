        ...
        <div class="container">
            ...
            <div class="row inner-sec-wthree">
                ...
                <div class="address row">
                    <div class="col-md-4 address-grid-inf-w3layouts" data-aos="zoom-out">
                        <div class="address-info">
                            ...
                            <h6>Phone</h6>
                                <a href="tel:<?=$sirket_phone?>"><?=$sirket_phone?></a>
                ...
                <div class="contact_grid_right">
                    <h6>If you want to get in touch please fill the form correctly.</h6>
                    <form action="./inc/form_post.php" method="post">
                        <div class="contact_left_grid">
                            ...
                            <textarea name="Message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Message...';}" required="">Your Message...</textarea>
