...
<body>
        ...
        <div class="container">
            ...
            <div class="row inner-sec-wthree">
                ...
                <div class="col-lg-7 bt-bottom-info" data-aos="fade-left">
                    ...
                    <?php
                    $query = $dbh->query('select content_en from about_us');
                    while ($row = $query->fetch()) {
                    ?>
                        <p class="mt-3"><?= $row['content_en'] ?></p>
                    <?php
                    }
                    ?>
                </div>
    ...
    <?php
    $query = '';
    $query = $dbh->query('select title_en, img_en, description_en, content_en from resmibelgeler where status_en = 1');
    $i = 0;
    while ($row = $query->fetch()) {
        if ($i == 0) {
        ?>
            ...
            <div class="container">
            <h3 class="tittle">Officially Documents
            </h3>
            <div class="row inner-sec-wthree">
